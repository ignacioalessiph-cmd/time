...
const LoadingSpinner = () => (
  <div className="relative">
    <div className="w-16 h-16 border-4 border-blue-500/30 border-t-blue-400 rounded-full animate-spin mx-auto"></div>
  </div>
)

// Simple thermometer display component
const ThermometerDisplay = ({ balance, totalEstimated }) => {
  const percentage = totalEstimated > 0 ? Math.min(100, Math.max(0, ((totalEstimated + balance) / totalEstimated) * 100)) : 50
  
  return (
    <div className="flex flex-col items-center">
      <div className="w-8 bg-gray-700 rounded-full h-32 relative overflow-hidden">
        <div 
        ...
        />
        <div className="absolute top-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gray-600 rounded-full" />
      </div>
      <div className={`mt-2 text-sm font-semibold ${balance >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
        {balance !== 0 && (balance > 0 ? '+' : '')}{balance}m
      </div>
    </div>
  )
}
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <LoadingSpinner />
          <p className="text-gray-400 mt-4">Loading your time balance data...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-900 p-3 sm:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Status Bar */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 p-4 bg-gray-800 border border-gray-700 rounded-3xl shadow-2xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-4 sm:mb-0">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></div>
              <span className="text-emerald-400 text-sm font-medium">Auto-saving enabled</span>
            </div>
            {lastSaved && (
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              onClick={exportData}
              className="bg-gray-700 hover:bg-gray-600 text-gray-200 px-4 py-2 rounded-lg transition-all duration-200 font-medium flex items-center gap-2 text-xs sm:text-sm"
              title="Export data"
            >
              <Download size={14} />
            ...
            <label className="bg-gray-700 hover:bg-gray-600 text-gray-200 px-4 py-2 rounded-lg transition-all duration-200 font-medium flex items-center gap-2 text-xs sm:text-sm cursor-pointer">
              <Save size={14} />
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 mb-6 lg:mb-10">
          {/* Today's Plan */}
          <div className="w-full lg:w-52 bg-gray-800 border border-gray-700 rounded-3xl shadow-2xl p-4 lg:p-5 order-2 lg:order-1">
        ...
        {/* Add Outcome */}
        <div className="bg-gray-800 border border-gray-700 rounded-3xl shadow-2xl p-6 lg:p-8 mb-6 lg:mb-10">
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:bg-gray-600 transition-all duration-200 flex-1"
              maxLength={100}
            />
            <button
              onClick={addOutcome}
              disabled={!newOutcome.trim()}
              className="bg-blue-500 hover:bg-blue-400 text-white px-6 py-3 rounded-xl transition-all duration-200 font-medium flex items-center justify-center gap-3 disabled:opacity-50"
            >
              <Plus size={18} />
        ...
        <div className="space-y-6">
          {outcomes.length === 0 ? (
            <div className="bg-gray-800 border border-gray-700 rounded-3xl shadow-2xl p-12 text-center">
            ...
            outcomes.map(outcome => {
              ...
              return (
                <div key={outcome.id} className="bg-gray-800 border border-gray-700 rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div className="flex items-center gap-4 flex-1 min-w-0">
                        <button
                          ...
                          className="text-gray-400 hover:text-blue-400 p-3 hover:bg-gray-700 rounded-2xl transition-all duration-200 flex-shrink-0"
                          title="Add step"
                        >
                          <List size={18} />
                        </button>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          ...
                          className="text-red-400 hover:text-red-300 p-3 hover:bg-red-900/30 rounded-2xl transition-all duration-200"
                      ...
                      <div className="mt-6">
                        <div className="flex flex-col sm:flex-row gap-4">
                          ...
                          <input
                            ...
                            className="bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:bg-gray-600 transition-all duration-200 w-full sm:w-24"
                            min="1"
                            max="999"
                          />
                          <button
                            ...
                            className="bg-emerald-500 hover:bg-emerald-400 text-white px-6 py-3 rounded-xl transition-all duration-200 font-medium disabled:opacity-50"
                          >
                            Add
                          </button>
                        </div>
                              ...
                              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="ml-8 flex flex-wrap items-center gap-3">
                                    ...
                                    <button
                                      ...
                                      className="text-gray-400 hover:text-blue-400 p-2 hover:bg-blue-900/30 rounded-xl transition-all duration-200"
                                      title="Add note"
                                    >
                                      <StickyNote size={16} />
                                    </button>
                                  ...
                                  {editingNotes === `${outcome.id}-${step.id}` && (
                                    <div className="ml-8 mt-4">
                                      <textarea
                                        ...
                                        className="bg-gray-700 border border-gray-600 rounded-xl px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400 focus:bg-gray-600 transition-all duration-200 w-full text-sm resize-none"
                                        rows="3"
                                        maxLength={500}
                                      />
                                    </div>
                                ...
                                <div className="flex flex-row lg:flex-col items-center gap-3">
                                    ...
                                    <>
                                      {isActive ? (
                                        <>
                                          ...
                                          <button
                                            onClick={pauseTimer}
                                            className="bg-yellow-500 hover:bg-yellow-400 text-white p-3 lg:p-4 rounded-xl transition-all duration-200 shadow-lg order-2"
                                            title="Pause timer"
                                          >
                                            <Pause size={18} />
                                          </button>
                                          <button
                                            ...
                                            className={`px-3 lg:px-4 py-3 lg:py-4 rounded-xl transition-all duration-200 shadow-lg font-semibold order-3 ${
                                              timeBank >= 10 
                                          ...
                                          <button
                                            ...
                                            className="bg-emerald-500 hover:bg-emerald-400 text-white p-3 lg:p-4 rounded-xl transition-all duration-200 shadow-lg order-4"
                                            title="Mark as done"
                                          >
                                            <Check size={18} />
                                          </button>
                                        ...
                                        <button
                                          ...
                                          className="bg-emerald-500 hover:bg-emerald-400 text-white p-3 lg:p-4 rounded-xl transition-all duration-200 shadow-lg"
                                          title="Start timer"
                                        >
                                          <Play size={18} />
                                        </button>
                                  ...
                                  <button
                                    ...
                                    className="text-red-400 hover:text-red-300 p-2 lg:p-3 hover:bg-red-900/30 rounded-xl transition-all duration-200"
                                    title="Delete step"
                                  >
                                    <Trash2 size={16} />
                                  </button>
